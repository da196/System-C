...
<head>
   ...
   <title>HRMS | All Strategic Targets</title>
                            ...
                            <h3>All Strategic Targets</h3>                            	
	                            <div class="table-responsive">
						           <table class="table table-striped table-bordered table-hover dataTables-strategic-goals" >
							           ...
							           <tbody class="strategicTargetsAjax">
...
function targetsDataTableFunction(){
	if(targetReady==0){
...
$(document).ready(function(){	
	...
	$.ajax({
		url: '${pageContext.request.contextPath}/all-strategic-targetsAjax',
		type: 'GET',
		success:function(data,textStatus,jqXHR){
			if(!data){
				...
				$.each(data,function(i,item){
					$(".strategicTargetsAjax").append('<tr>'+
															'<td>'+ ++i +'</td>'+
															'<td>'+item.name+'</td>'+
															'<td>'+
...
function confirmDelete(targetID){
	$.confirm({
	    ...
	    buttons: {
	        confirm: function () {
	        	$.ajax({
	        		url: '${pageContext.request.contextPath}/delete-strategic-targetAjax/'+targetID,
	        		type: 'PUT',
