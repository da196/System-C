...
<head>
   ...
   <title>HRMS | All Strategic Goals</title>
                            ...
                            <h3>All Strategic Goals</h3>                            	
	                            <div class="table-responsive">
						           <table class="table table-striped table-bordered table-hover dataTables-strategic-goals" >
							           ...
							           <tbody class="performanceGoalsTabularAjax">
...
$(document).ready(function(){	
	...
	$.ajax({
		url: '${pageContext.request.contextPath}/all-strategic-goalsAjax',
		type: 'GET',
		success:function(data,textStatus,jqXHR){
			if(!data){
				...
				$.each(data,function(i,item){
					$(".performanceGoalsTabularAjax").append('<tr>'+
																'<td>'+ ++i +'</td>'+
...
function confirmDelete(goalID){
	$.confirm({
	    ...
	    buttons: {
	        confirm: function () {
	        	$.ajax({
	        		url: '${pageContext.request.contextPath}/delete-strategic-goalAjax/'+goalID,
	        		type: 'PUT',
