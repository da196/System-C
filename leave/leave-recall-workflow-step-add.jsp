...
<div class="modal-dialog">
	<div class="modal-content animated bounceInRight">
		<div class="modal-header">
			...
			<h4 class="modal-title">+ Add Leave Recall Workflow Step</h4>
		</div>
		<form:form
			action="${pageContext.request.contextPath}/v1/leave-recall-workflow-step"
			role="form" method="post" modelAttribute="addTrainingWorkflowStep"
			id="formAddLeaveRecallWorkflowStep" enctype="multipart/form-data">
			...
			<div class="modal-footer">
				...
				<button type="button" value="submit" class="btn btn-primary"
					id="addLeaveRecallWorkflowStepBtn">Save changes</button>
