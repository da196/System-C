...
<head>
   ...
   <title>HRMS | Leave Recall Workflow</title>
...
<div class="col-lg-12">
    <div class="tabs-container">
        <ul class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#tab-3"> <i class="fa fa-map-marker"></i> Leave Recall Workflow</a></li>
        </ul>
                ...
                <div class="panel-body">
										<p align="right">
											<button type="button"
												...
												data-toggle="modal" data-target="#addTrainingWorkflow">+ Add Leave Recall
												Workflow</button>
										</p>
										<br>
	...
	<div class="modal inmodal" id="addTrainingWorkflow"
		...
		<!-- Add Modal -->
		<jsp:include page="leave-recall-workflow-add.jsp" />
		<!-- End Add Modal-->
	</div>
	...
	<div class="modal inmodal" id="editTrainingWorkflow"
			tabindex="99999" role="dialog" aria-hidden="true">
		<!-- Add Modal -->
		<jsp:include page="leave-recall-workflow-edit.jsp" />
		<!-- End Add Modal-->
	</div>
...
src="<c:url value="/resources/dist/js/FormValidation.min.js" />"></script>
	...
	<script src="<c:url value="/resources/js/validation/ui_validation_leave_recall_workflow-add.js" />"></script>
	<script src="<c:url value="/resources/js/validation/ui_validation_leave_recall_workflow-edit.js" />"></script>
<!-- Page-Level Scripts -->
<script>
    ...
    $(document).ready(function(){
        $('.dataTables-leaveTypes').DataTable({
            ...
            buttons: [
                { extend: 'copy'},
                {extend: 'csv'},
                {extend: 'excel', title: 'Leave Recall Workflow'},
                {extend: 'pdf', title: 'Leave Recall Workflow'},
    ...
    // show details
    	function showTraningDetails(id){
    		...
    		if(id){			
    			...
    			var $apiUrl = "${pageContext.request.contextPath}/v1/leave-recall-workflow-view-details/"+id;
    			$.ajax({
    				url:$apiUrl,
    				type:'GET',
    				statusCode: {            	    	
            	    	208: function(responseObject, textStatus, jqXHR) {
            	            showError("Duplicate Leave Recall Workflow details not allowed.");
            	        },
            	        ...
            	        503: function(responseObject, textStatus, errorThrown) {
            	        	showError("Leave Recall Workflow service unavailable");
            	        }           
            	    },
    				success: function(data, textStatus, jqXHR){
    	...
    	function deleteTraningDetails(id){
    		if(id){			
    			...
    			var $apiUrl = "${pageContext.request.contextPath}/v1/leave-recall-workflow-delete/"+id;
    			
                $.confirm({
                    title: 'Warning!',
                    content: 'Please confirm to delete Leave Recall Workflow.',
                    type: 'red',
                    buttons: {
                        ok: {
                            text: "ok",
                            ...
                            action: function(){
                    			$.ajax({
                    				...
                    				success: function(data, textStatus, jqXHR){
                                        ...
                                        $.confirm({
                                            title: 'Congrats!',
                                            content: 'Leave Recall Workflow successfully deleted.',
                                            type: 'green',
                                            buttons: {
                                                ok: {
                                                    text: "ok",
                    				...
                    				error:function(jqXHR, textStatus, errorThrown){
                    					console.log("Failed to retrieve Leave Recall Workflow details");
                    				}
                    			});
                            }
                        },  cancel: {
