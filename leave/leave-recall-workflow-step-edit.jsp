...
<div class="modal-dialog">
	<div class="modal-content animated bounceInRight">
		<div class="modal-header">
			...
			<h4 class="modal-title">+ Edit Leave Recall Workflow Step</h4>
		</div>
		<form:form
			action="${pageContext.request.contextPath}/v1/update-leave-recall-workflow-step"
			role="form" method="post" modelAttribute="addTrainingWorkflowStep"
			id="formUpdateLeaveRecallWorkflowStep">
			...
			<div class="modal-footer">
				...
				id="editLeaveRecallWorkflowStepBtn">Save changes</button>
