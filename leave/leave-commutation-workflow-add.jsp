						...
						<div class="modal-dialog">
							<div class="modal-content animated bounceInRight">
								<div class="modal-header">
									...
									<h4 class="modal-title">+ Add Leave Commutation Workflow</h4>
								</div>
								<form:form action="${pageContext.request.contextPath}/v1/leave-commutation-workflow-add" role="form" method="post"
									modelAttribute="addTrainingWorkflow" id="formAddLeaveCommutationWorkflow" enctype="multipart/form-data">
									...
									<div class="modal-footer">
										...
										<button type="button" value="submit" class="btn btn-primary" id="addLeaveCommutationWorkflowBtn">Save
											changes</button>
