...
<head>
   ...
   <title>HRMS | Leave Workflow Step</title>
...
<div class="col-lg-12">
    <div class="tabs-container">
        <ul class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#tab-3"> <i class="fa fa-map-marker"></i> Leave Workflow Step</a></li>
        </ul>
	...
	<div class="modal inmodal" id="addTrainingWorkflowStep"
		...
		<!-- Add Modal -->
		<jsp:include page="leave-workflow-step-add.jsp" />
		<!-- End Add Modal-->
	</div>
	...
	<div class="modal inmodal" id="editTrainingWorkflowStep"
			tabindex="99999" role="dialog" aria-hidden="true">
		<!-- Add Modal -->
		<jsp:include page="leave-workflow-step-edit.jsp" />
		<!-- End Add Modal-->
	</div>
...
<script src="<c:url value="/resources/dist/js/FormValidation.min.js" />"></script>
	...
	<script src="<c:url value="/resources/js/validation/ui_validation_leave_workflow-step-edit.js" />"></script>
	<script src="<c:url value="/resources/js/validation/ui_validation_leave_workflow-step-add.js" />"></script>
...
$(document).ready(function() {
    ...
    $(document).ready(function(){
    	...
    	$.ajax({
    		url: '${pageContext.request.contextPath}/get-leave-supervisor-designation-listAjax',
    		type: 'GET',
    	...
    	$.ajax({
    		url: '${pageContext.request.contextPath}/get-leave-workflow-name-listAjax',
    		type: 'GET',
    		success:function(data,textStatus,jqXHR){
    			if(!data){
    				alert("No Data Received");
    ...
    // show details
    	function showTraningDetails(id){ 	
    		...
    		if(id){			
    			...
    			var $apiUrl = "${pageContext.request.contextPath}/v1/getLeaveByID/"+id;
    			$.ajax({
    				url:$apiUrl,
    				type:'GET',
    				statusCode: {            	    	
            	    	208: function(responseObject, textStatus, jqXHR) {
            	            showError("Duplicate Leave Workflow Step details not allowed.");
            	        },
    				...
    				error:function(jqXHR, textStatus, errorThrown){
    					console.log("Failed to retrieve Leave Workflow Step details");
    				}
    			});
    		}
    	}
    	...
    	function deleteTraningDetails(id){
    		if(id){			
    			...
    			var $apiUrl = "${pageContext.request.contextPath}/v1/leave-workflow-step-delete/"+id;
    			
                $.confirm({
                    title: 'Warning!',
                    content: 'Please confirm to delete Leave Workflow Step.',
                    type: 'red',
                    buttons: {
                        ok: {
                            text: "ok",
                            ...
                            action: function(){
                    			$.ajax({
                    				...
                    				statusCode: {            	    	
                            	        ...
                            	        404: function(responseObject, textStatus, jqXHR) {
                            	        	showError("You are Leave Workflow Step Details not found");
                            	        },
                            	        412: function(responseObject, textStatus, jqXHR) {
                            	        	showError("Your request is not valid, please reveiew and submit again");
                            	        },
