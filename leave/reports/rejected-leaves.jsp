...
<head>
   ...
   <title>HRMS | Rejected leaves</title>
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form role="form" class="form-inline" id="filterAttributes">
                                ...
                                <button class="btn btn-warning btn-sm" id="getRejectedLeaves" type="button" value="submit"><i class="fa fa-search"></i> Get Rejected Leaves</button>
                            </form>
                            <hr>
                            <!-- Pending leaves report -->
							<div class="table-responsive hideShow-status">
								<div class="table-header" style="color: red"></div>
								<table class="footable table table-stripped toggle-arrow-tiny table-hover pendingLeaves-datatable">
									<thead>
										<tr>
											...
											<th data-hide="phone">Rejected By</th>
											<th data-hide="phone">Reason</th>
										</tr>
									</thead>
									<tbody class="rejectedLeavesRows">
...
$(document).ready(function(){
	...
	/************** Get rejected leaves by Ajax ***************/   	  	  
    $("#getRejectedLeaves").click(function(){
        ...
        $.ajax({
    		url: '${pageContext.request.contextPath}/get-rejected-leavesByAjax',
    		type: 'GET',
    		success:function(data,textStatus,jqXHR){
    			if(!data){
    				...
    				$(".table-header").text("");
    				$(".rejectedLeavesRows").text("");
    				if(date1 && date2){
    					$(".table-header").append('<p><h2><center> Rejeceted Leaves, startdates from '+date1+' to '+date2+' </center></h2></p>');
    				}else{
    					$(".table-header").append('<p><h2><center> All Rejected Leaves </center></h2></p>');
    				}
    				  console.log(data);  				
