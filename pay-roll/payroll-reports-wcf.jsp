...
<title>HRMS | Workers Compesation Fund Report</title>
					...
					<div class="col-md-12">
						<div class="ibox float-e-margins ibox-run-contribution">
							...
							<div class="ibox-title custom-ibox-title">
								<h5>Workers Compesation Fund Report</h5>
<!-- 								<div class="ibox-tools">
							...
							<div class="ibox-content ibox-run-contribution-content">
								<div class="row container-run-contribution">
									<div class="col-md-9">
										<form:form id="formRunContribution" action="${pageContext.request.contextPath}/v1/wcf-run"	modelAttribute="wcfRun" method="POST" enctype="multipart/form-data">
											<div class="row">
												<div class="col-md-12">
...
/* 		$('#btnViewJournal').attr('disabled',true);
	...
	<script src="<c:url value="/resources/js/validation/ui_validation_payroll_wcf_report.js" />"></script>	
	<script>
