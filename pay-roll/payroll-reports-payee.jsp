...
<!-- 								<div class="ibox-tools">
							...
							<div class="ibox-content ibox-run-contribution-content">
								<div class="row container-run-contribution">
									<div class="col-md-9">
										<form:form id="formRunContribution" action="${pageContext.request.contextPath}/v1/payee-run"	modelAttribute="payeeRun" method="POST" enctype="multipart/form-data">
											<div class="row">
												<div class="col-md-12">
...
/* 		$('#btnViewJournal').attr('disabled',true);
	...
	<script src="<c:url value="/resources/js/validation/ui_validation_payroll_payee_report.js" />"></script>	
	<script>
