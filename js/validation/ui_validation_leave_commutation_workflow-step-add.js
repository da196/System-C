...
document.addEventListener('DOMContentLoaded', function(e) {
 ...
 const addLeaveCommutationWorkflowStepBtn = document.getElementById('addLeaveCommutationWorkflowStepBtn');
 const formAddLeaveCommutationWorkflowStep = document.getElementById('formAddLeaveCommutationWorkflowStep');
 const fv = FormValidation.formValidation(formAddLeaveCommutationWorkflowStep, {
   fields: { 
	   workflowid:{
     		validators: {
                 notEmpty: {
 ...
 addLeaveCommutationWorkflowStepBtn.addEventListener('click', function() {
     fv.validate().then(function(status) {
             if(status === 'Valid'){

             var $apiUrl = $('#formAddLeaveCommutationWorkflowStep').attr('action');
             var $data = $('#formAddLeaveCommutationWorkflowStep').serializeObject();//.serializeArray();//serialize();
