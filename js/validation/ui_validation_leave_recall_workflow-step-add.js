...
document.addEventListener('DOMContentLoaded', function(e) {
 ...
 const addLeaveRecallWorkflowStepBtn = document.getElementById('addLeaveRecallWorkflowStepBtn');
 const formAddLeaveRecallWorkflowStep = document.getElementById('formAddLeaveRecallWorkflowStep');
 const fv = FormValidation.formValidation(formAddLeaveRecallWorkflowStep, {
   fields: { 
	   workflowid:{
     		validators: {
                 notEmpty: {
 ...
 addLeaveRecallWorkflowStepBtn.addEventListener('click', function() {
     fv.validate().then(function(status) {
             if(status === 'Valid'){

             var $apiUrl = $('#formAddLeaveRecallWorkflowStep').attr('action');
             var $data = $('#formAddLeaveRecallWorkflowStep').serializeObject();//.serializeArray();//serialize();
...
//                             $('#submitTrainingBtn').attr("disabled", true);
                             $.confirm({
                                 title: 'Congrats!',
                                 content: 'Leave Recall Workflow Step successfully added.',
                                 type: 'green',
                                 buttons: {
                                     ok: {
                                         text: "ok",
