            	    ...
            	    success: function(data, textStatus, jqXHR) {
            	    	if(data){
                	        ...
                	        if(status==200 || status==208){
                	          ...
                	          s += '</thead>';
                	          s += '<tbody >';
                				$.each(responseData.workersCompensationFundlist, function(index,resData) {                   
                                	s += '<tr>';
                                	s += '<td>' + (index + 1) + '</td>';
                    	      ...
                    	      $('#datatables').DataTable({
                      	            ...
                      	            buttons: [
                      	                {extend: 'copy', title: 'WCF Report of - ' + journalDate},
                      	                {extend: 'csv', title: 'WCF Report of - ' + journalDate},
                      	                {extend: 'excel', title: 'WCF Report of - ' + journalDate},
                      	                {extend: 'pdf', title: 'WCF Report of - ' + journalDate},
                      	                {extend: 'print',
