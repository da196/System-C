...
document.addEventListener('DOMContentLoaded', function(e) {
 ...
 const editLeaveCommutationWorkflowStepBtn = document.getElementById('editLeaveCommutationWorkflowStepBtn');
 const formUpdateLeaveCommutationWorkflowStep = document.getElementById('formUpdateLeaveCommutationWorkflowStep');
 const fv = FormValidation.formValidation(formUpdateLeaveCommutationWorkflowStep, {
   fields: { 
	   workflowid:{
     		validators: {
                 notEmpty: {
 ...
 editLeaveCommutationWorkflowStepBtn.addEventListener('click', function() {
     fv.validate().then(function(status) {
             if(status === 'Valid'){

            	  var $apiUrl = $('#formUpdateLeaveCommutationWorkflowStep').attr('action');
                  var $data = $('#formUpdateLeaveCommutationWorkflowStep').serializeObject();//.serializeArray();//serialize();
...
//                             $('#submitTrainingBtn').attr("disabled", true);
                             $.confirm({
                                 title: 'Congrats!',
                                 content: 'Leave Commutation Workflow Step successfully Updated.',
                                 type: 'green',
                                 buttons: {
                                     ok: {
                                         text: "ok",
