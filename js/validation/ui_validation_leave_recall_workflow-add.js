...
document.addEventListener('DOMContentLoaded', function(e) {
 ...
 const addLeaveRecallWorkflowBtn = document.getElementById('addLeaveRecallWorkflowBtn');
 const formAddLeaveRecallWorkflow = document.getElementById('formAddLeaveRecallWorkflow');
 const fv = FormValidation.formValidation(formAddLeaveRecallWorkflow, {
   fields: { 
     	name:{
     		validators: {
                 notEmpty: {
...
// });
 // click listener
 addLeaveRecallWorkflowBtn.addEventListener('click', function() {
     fv.validate().then(function(status) {
             if(status === 'Valid'){

             var $apiUrl = $('#formAddLeaveRecallWorkflow').attr('action');
             var $data = $('#formAddLeaveRecallWorkflow').serializeObject();//.serializeArray();//serialize();
