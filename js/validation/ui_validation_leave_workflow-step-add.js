...
document.addEventListener('DOMContentLoaded', function(e) {
 ...
 const addLeaveWorkflowStepBtn = document.getElementById('addLeaveWorkflowStepBtn');
 const formAddLeaveWorkflowStep = document.getElementById('formAddLeaveWorkflowStep');
 const fv = FormValidation.formValidation(formAddLeaveWorkflowStep, {
   fields: { 
	   workflowid:{
     		validators: {
                 notEmpty: {
 ...
 addLeaveWorkflowStepBtn.addEventListener('click', function() {
     fv.validate().then(function(status) {
             if(status === 'Valid'){

             var $apiUrl = $('#formAddLeaveWorkflowStep').attr('action');
             var $data = $('#formAddLeaveWorkflowStep').serializeObject();//.serializeArray();//serialize();
...
//                             $('#submitTrainingBtn').attr("disabled", true);
                             $.confirm({
                                 title: 'Congrats!',
                                 content: 'Leave Workflow Step successfully added.',
                                 type: 'green',
                                 buttons: {
                                     ok: {
                                         text: "ok",
