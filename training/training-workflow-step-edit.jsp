...
<div class="modal-dialog">
	<div class="modal-content animated bounceInRight">
		...
		<form:form
			action="${pageContext.request.contextPath}/v1/update-training-workflow-step"
			role="form" method="post" modelAttribute="addTrainingWorkflowStep"
			id="formUpdateTrainingWorkflowStep">
			...
			<div class="modal-footer">
				...
				id="editTrainingWorkflowStepBtn">Save changes</button>
