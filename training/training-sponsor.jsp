...
<head>
   ...
   <title>HRMS | Training Sponsor</title>
...
<div class="col-lg-12">
    <div class="tabs-container">
        <ul class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#tab-3"> <i class="fa fa-map-marker"></i> Training Sponsor</a></li>
        </ul>
        <div class="tab-content">
            <div id="tab-3" class="tab-pane active">
             ...
             <div class="table-responsive">
		           ...
		           <tbody>
		           <c:if test="${not empty trainingSponsor}">
    				<c:forEach var="trainingSponsor" items="${trainingSponsor}" varStatus="status">
		            <tr class="gradeX">
		                <td width="30px">${status.count}</td>
						<td><c:out value="${trainingSponsor.name}"/></td>
						<td><c:out value="${trainingSponsor.description}"/></td>
