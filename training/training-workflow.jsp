...
<head>
   ...
   <title>HRMS | Training Workflow</title>
...
<div class="col-lg-12">
    <div class="tabs-container">
        <ul class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#tab-3"> <i class="fa fa-map-marker"></i> Training Workflow</a></li>
        </ul>
	...
	<div class="modal inmodal" id="addTrainingWorkflow"
		...
		<!-- Add Modal -->
		<jsp:include page="training-workflow-add.jsp" />
		<!-- End Add Modal-->
	</div>
	...
	<div class="modal inmodal" id="editTrainingWorkflow"
			tabindex="99999" role="dialog" aria-hidden="true">
		<!-- Add Modal -->
		<jsp:include page="training-workflow-edit.jsp" />
		<!-- End Add Modal-->
	</div>
...
src="<c:url value="/resources/dist/js/FormValidation.min.js" />"></script>
	...
	<script src="<c:url value="/resources/js/validation/ui_validation_training_workflow-add.js" />"></script>
	<script src="<c:url value="/resources/js/validation/ui_validation_training_workflow-edit.js" />"></script>
<!-- Page-Level Scripts -->
<script>
...
$(document).ready(function() {
	...
	$('#supervisordesignationidEdit').select2({
		width : "100%",
		dropdownParent: $("#editTrainingWorkflow").trigger("change")
	});
    ...
    function showTraingDetailsModal(data){
    	...
    	$('#supervisordesignationidEdit').val(data.supervisordesignationid);
    ...
    // show details
    	function showTraningDetails(id){
    		...
    		if(id){			
    			...
    			var $apiUrl = "${pageContext.request.contextPath}/v1/training-workflow-view-details/"+id;
    			$.ajax({
    				url:$apiUrl,
    				type:'GET',
    				statusCode: {            	    	
    	...
    	function deleteTraningDetails(id){
    		if(id){			
    			...
    			var $apiUrl = "${pageContext.request.contextPath}/v1/training-workflow-delete/"+id;
