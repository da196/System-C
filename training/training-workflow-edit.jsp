						...
						<div class="modal-dialog">
							<div class="modal-content animated bounceInRight">
								<div class="modal-header">
									...
									<h4 class="modal-title">+ Edit Training Workflow</h4>
								</div>
								<form:form action="${pageContext.request.contextPath}/v1/training-workflow-update" role="form" method="post"
									modelAttribute="editTrainingWorkflow" id="formEditTrainingWorkflow" >
									...
									<div class="modal-footer">
										...
										<button type="button" value="submit" class="btn btn-primary" id="editTrainingWorkflowBtn">Save
											changes</button>
