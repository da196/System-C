...
<head>
   ...
   <title>HRMS | Nationalities</title>
				...
				<div class="col-lg-12">
                    <div class="tabs-container">
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#tab-3"> <i class="fa fa-map-marker"></i> Nationalities</a></li>
                        </ul>
                            ...
                            <div id="tab-3" class="tab-pane active">
                                <div class="panel-body">
                                    <div class="table-responsive">
					                    ...
					                    <tbody>
				                    	<c:if test="${not empty nationalities}">
	                    					<c:forEach var="nationality" items="${nationalities}" varStatus="status">
							                    <tr class="gradeX">
							                        <td width="30px">${status.count}</td>
							                        <td><c:out value="${nationality.name}"/></td>
							                        <td><c:out value="${nationality.description}"/></td>
							                    </tr>
						                    </c:forEach>
		                    			</c:if>
					                    </tbody>
