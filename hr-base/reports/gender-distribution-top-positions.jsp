...
<head>
   ...
   <title>HRMS | Gender distribution Seniors and Top Positions</title>
               ...
               <div class="col-lg-12">
	               <div class="ibox float-e-margins" id="printableArea">
	                   <div class="ibox-title">
	                       <h5>Gender distribution Seniors and Top Positions</h5>
	                   ...
	                   <div class="ibox-content">
	                   		<div class="table-responsive">
			                    ...
			                    <tbody>
		                    		<c:if test="${not empty genderDistTopStaffs}">
                   					<c:forEach var="genderDistTopStaff" items="${genderDistTopStaffs}" varStatus="status">
					                    <tr class="gradeX">
					                        <td width="30px">1</td>
					                        <td>Directors</td>
					                        <td>${genderDistTopStaff.maledirectors}</td>
					                        <td>${genderDistTopStaff.femaledirectors}</td>
					                        <td></td>
					                    </tr>	
					                    <tr class="gradeX">
					                        <td width="30px">2</td>
					                        <td>Heads</td>
					                        <td>${genderDistTopStaff.maleheads}</td>
					                        <td>${genderDistTopStaff.femaleheads}</td>
					                        <td></td>
					                    </tr>						                    
				                    </c:forEach>					                    	
                    			</c:if>
...
$(document).ready(function() {
	var API_URL = '${pageContext.request.contextPath}/gender-distribution-top-positionsAjax'
	$.ajax({
		url:API_URL,
		type:'GET',
		success:function(data,textStatus,jqXHR){
			if(!data){
				...
				var maledirectors = data.maledirectors;
				var femaledirectors = data.femaledirectors;
				var maleheads = data.maleheads;
				var femaleheads = data.femaleheads;
